...
namespace TheEight.WebApp.Repositories.Accounts
{
    public class AccountsRepository : IAccountsRepository
    {
        ...
        public async Task CreateSquadInvitesAsync(IEnumerable<string> emails, int squadId, SquadMemberRole role,
        ...
        public async Task<SquadMemberRole> GetSquadMemberRoleForUser(int userId, int squadId)
        {
            const string sqlCmd =
            ...
            var role = await _dbConn.QuerySingleOrDefaultAsync<SquadMemberRole>(sqlCmd, sqlParams);
            return role;
        }
    }
}