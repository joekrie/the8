...
var StateStreamMixin = require("../index").StateStreamMixin;
var cleanAllSubscriptions = require("../index").cleanAllSubscriptions;
var Rx = require("rx");
...
test('StateStreamMixin', function(t) {
  ...
  t.test('errors', function(t) {
    ...
    }, /Component use the StateStreamMixin it should provide a 'getStateStream' function/, 'it should throw an error if getStateStream is not defined');
    ...
    t.throws(function() {
      testUtils.render(React.createElement(Component));
    }, /'Component.getStateStream' should return an Rx.Observable, given : \[object Object\]/, 'it should throw an error if getStateStream does not return an observable');
    Component = React.createClass({
      displayName: 'Component',
      mixins: [StateStreamMixin],
      getStateStream: function() {
    ...
    t.throws(function() {
      testUtils.render(React.createElement(Component));
    }, /The observable returned by 'Component.getStateStream' should publish Objects or null given : 1/, 'it should throw an error if the Observable returned by getStateStream does not not resolve with an object or null');
    t.end();
  });
  t.test('behavior', function(t) {
    ...
    t.deepEquals(component.state, {
      foo: 'bar',
      hello: 'world'
    }, 'state should have been merged with the new value of stateStream');
    testUtils.unmount();
