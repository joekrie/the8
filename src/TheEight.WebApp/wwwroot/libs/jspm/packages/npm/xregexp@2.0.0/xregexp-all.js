  ...
  (function(XRegExp) {
    ...
    XRegExp.matchRecursive = function(str, left, right, flags, options) {
      ...
      if (escapeChar) {
        ...
        esc = new RegExp("(?:" + escapeChar + "[\\S\\s]|(?:(?!" + XRegExp.union([left, right]).source + ")[^" + escapeChar + "])+)+", flags.replace(/[^im]+/g, ""));
      }
      while (true) {
        if (escapeChar) {
