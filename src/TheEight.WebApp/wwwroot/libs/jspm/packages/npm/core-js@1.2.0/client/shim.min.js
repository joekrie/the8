    ...
    !function(b) {
      ...
      var e = b(2),
          ...
          J = function(a) {
            ...
            return b._k = a, p && m && t(j, a, {
              configurable: !0,
              set: function(b) {
                d(this, c) && d(this[c], a) && (this[c][a] = !1), t(this, a, q(1, b));
              }
            }), b;
          },
          r = function defineProperty(a, b, e) {
            return e && d(h, b) ? (e.enumerable ? (d(a, c) && a[c][b] && (a[c][b] = !1), e = k(e, {enumerable: q(0, !1)})) : (d(a, c) || i(a, c, q(1, {})), a[c][b] = !0), t(a, b, e)) : i(a, b, e);
          },
      ...
      l || (f = function Symbol() {
        ...
        return J(P(arguments[0]));
      }, u(f.prototype, "toString", function toString() {
        return this._k;
      }), e.create = F, e.isEnum = E, e.getDesc = D, e.setDesc = r, e.setDescs = s, e.getNames = C.get = B, e.getSymbols = y, p && !b(38) && u(j, "propertyIsEnumerable", E, !0)), (!l || H(function() {
        return "[null]" != JSON.stringify([f()]);
      })) && u(f.prototype, "toJSON", function toJSON() {
        return l && M(this) ? this : void 0;
      });
      var x = {
        "for": function(a) {
          return d(n, a += "") ? n[a] : n[a] = f(a);
        },
      ...
      e.each.call("hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), function(a) {
        var b = A(a);
        x[a] = l ? b : J(b);
      }), m = !0, g(g.G + g.W, {Symbol: f}), g(g.S, "Symbol", x), g(g.S + g.F * !l, "Object", {
        create: F,
        defineProperty: r,
        defineProperties: s,
      ...
      }), v(f, "Symbol"), v(Math, "Math", !0), v(G.JSON, "JSON", !0);
    }, function(c, f, a) {
      var d = a(10),
          e = a(14),
          b = a(27)("toStringTag");
