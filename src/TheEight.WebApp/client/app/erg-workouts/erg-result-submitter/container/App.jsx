	...
	render() {
		...
		return (
			<div className="boat-lineup-planner">
				<UnassignedAttendeeList unassignedAttendees={unassignedAttendees} onUnassignAttendee={onUnassignAttendee} />
				<BoatList onAssignAttendee={onAssignAttendee} onMoveAttendee={onMoveAttendee} boats={boats} />
			</div>
		);
	}
}
