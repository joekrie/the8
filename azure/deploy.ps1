...
$ResourceGroup = If ($env:APPVEYOR_REPO_BRANCH -eq "master") {"the8-prod"} Else {"the8-dev"}

New-AzureRmResourceGroupDeployment -ResourceGroupName "the8-sandbox" -TemplateFile "azuredeploy-test.json"
